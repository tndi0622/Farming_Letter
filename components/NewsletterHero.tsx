    ...
    return (
        <div className="relative w-full h-screen border-b border-white/5 flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
                ...
                {/* Badge */}
                <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    <Zap className="w-4 h-4 text-[--warning]" />
                    <span className="text-sm font-medium text-gray-300">5만 명의 게이머와 함께하세요</span>
                </div>

                {/* Main Heading */}
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white to-white/50 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
                    게임 트렌드 <br />
                    <span className="text-[--primary]">매일 아침 배송.</span>
                </h1>

                {/* Subheading */}
                <p className="text-xl md:text-2xl text-gray-400 mb-10 max-w-2xl leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
                ...
                <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
                    {status === 'success' ? (
                        ...
                        <form onSubmit={handleSubmit} className="relative group">
                            ...
                            <div className="relative flex items-center bg-black rounded-full p-2 border border-white/10 shadow-2xl">
                                ...
                                <button
                                    ...
                                    className="px-8 py-3 bg-white text-black font-bold rounded-full hover:bg-gray-200 transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center space-x-2"
                                >
