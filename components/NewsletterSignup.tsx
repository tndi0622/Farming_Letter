    ...
    return (
        <section className="relative overflow-hidden py-12 md:py-24 rounded-3xl mx-4 sm:mx-0 my-10 md:my-20">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
                ...
                <h2 className="text-2xl md:text-5xl font-bold mb-4 md:mb-6 tracking-tight text-white">
                    게임 트렌드의 중심
                </h2>
                ...
                <div className="max-w-md mx-auto w-full">
                    <a
                        ...
                        className="w-full inline-flex items-center justify-center px-8 py-4 bg-white text-black font-bold text-lg rounded-full hover:bg-gray-200 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                    >
                        <span>무료 구독하기</span>
                    </a>
                </div>
