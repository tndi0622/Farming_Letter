        ...
        <section className="py-16 md:py-24 border-b border-white/5">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-2xl md:text-3xl font-bold mb-4">왜 '파밍레터'인가요?</h2>
                    <p className="text-gray-400">쏟아지는 게임 뉴스 속에서 길을 잃지 않도록.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {features.map((feature, idx) => {
                        ...
                        return (
                            <div key={idx} className="bg-white/5 p-6 rounded-2xl border border-white/5 hover:bg-white/10 transition-colors text-center group">
                                ...
                                <p className="text-sm text-gray-400 leading-relaxed word-keep break-keep">
                                    {feature.description}
                                </p>
                            </div>
                        );
